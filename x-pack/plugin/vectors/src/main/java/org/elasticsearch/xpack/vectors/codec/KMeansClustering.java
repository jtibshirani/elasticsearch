...
public class KMeansClustering {
    ...
    public static void runPQKMeansClustering(
        ...
        // TODO: can we sample a <fraction> of vectors only once, decode only once and keep in memory (mmap? floatbuffer?)
        // instead of reading and decoding docValues for every interation
